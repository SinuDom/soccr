    ...
    <div className="min-h-dvh max-w-2xl mx-auto p-5 pt-8 w-full flex flex-col">
      <header className="flex items-center justify-between mb-4">
        <div>
          ...
          <h1 className="text-2xl font-black tracking-tight mt-1">Library</h1>
        </div>
        <div className="text-xs text-white/50">{videos.length} videos</div>
      </header>

      <p className="text-white/60 text-sm mb-4">
        Read-only. Add or remove videos by editing
            ...
            return (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <a href={v.url} target="_blank" rel="noreferrer" className="text-xs text-white/50 truncate block hover:underline">
                    {v.url}
                  </a>
                </div>
                {isSeen ? (
